...
setInterval(() => {
  http.get(`http://dour-internal-reptile.glitch.me/`); ///تعديل مهم حط بدل 333م البروجكت
}, 280000);
...
const dev = ["541375390602493982"]; ///تعديل مهم حط ايدي حسابك
const admin = "=";
var owner = "541375390602493982"; // Owner Bot Mention /// تعديل مهم حط ايدي حسابكتعديل مهم ايدي حسابك
...
client.on("ready", () => {
  ...
  console.log(`----------------`);
  console.log(
    `ON ${client.guilds.size} Servers '     Script By : 1 `
  );
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setActivity("edarah"); ///تعديل مهم غير كلمة هيلب وبرميوم اللي بدك اياه مثل اسم سيرفرك
...
client.on("message", zaid => {
  if (zaid.content === "=bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@541375390602493982>`, true) // تعديل مهم عدل هذا الرقم لايدي حسابك
      .setImage("")
